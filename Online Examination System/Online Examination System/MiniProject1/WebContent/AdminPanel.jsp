...
else
{
	...
	%>
      ...
      <div class="col-sm-6"><center><input onclick="location.href='QuestionList.jsp'"type="button" value="Add Question" class="btn btn-outline-primary btn-lg btn-block"></center></div>
