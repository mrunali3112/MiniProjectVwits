...
%><div  height="300" width=100% ><pre><h1><center><font color="green">Results</font></center></h1></pre></div><%
%>
<table class="table table-hover">
  <thead >
    <tr class="table-warning">
      <th colspan="3" scope="col"><center><pre><h4>Name:-<%=session.getAttribute("name") %> </h4></pre></center></th>
    </tr>
  </thead>
  <tbody>
