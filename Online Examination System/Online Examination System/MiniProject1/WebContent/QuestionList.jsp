...
<center><h3><pre><font color="black">List of all questions</font></pre></h3></center>
...
<th colspan="4"  ><center><input type="button" class="btn btn-outline-danger" value="Back" onclick="location.href='AdminPanel.jsp'"></center></th>
